...
print(solution("aabcaaabcaaabcaaabca"))
print(solution("abc"))
print(solution("abca"))
print(solution("abcab"))
print(solution("aabb"))
print(solution("abcbabc"))
print(solution("abcbabcb"))
print(solution("abcbabcb"))
print(solution("aabaaaaac"))
print(solution("aaaaaaaaaaaaaabaaaaaaaaaaaaaab"))
print(solution("abbbbaabbbba"))
print(solution("abacabaeabacabaeabacabaeabacabae"))
print(solution("abcaabcaabca"))
print(solution("aabbaabb"))
print(solution("aaaa"))
print(solution("abacabacabac"))
print(solution("aaaaaaaaaaaaaaabbbbbbaaaaaaaaaaaaaaabbbbbb"))
